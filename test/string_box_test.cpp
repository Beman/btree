...
namespace
{
  ...
  {
    boost::btree::string_box<5> x0("");
    BOOST_TEST_EQ(x0.size(), 0U);
    BOOST_TEST(x0.empty());
    
    boost::btree::string_box<5> x3("abc");
    BOOST_TEST_EQ(x3.size(), 3U);
    BOOST_TEST(!x3.empty());
    BOOST_TEST(x3 == "abc");
    
    boost::btree::string_box<5> x5("abcdef");
  ...
  {
    boost::btree::string_box<5> x0(std::string(""));
    BOOST_TEST_EQ(x0.size(), 0U);
    BOOST_TEST(x0.empty());
    
    boost::btree::string_box<5> x3(std::string("abc"));
    BOOST_TEST(x3 == "abc"); 
    
    boost::btree::string_box<5> x5(std::string("abcdef"));
    BOOST_TEST(x5 == "abcde"); 
  }

  void copy_construct()
  {
    boost::btree::string_box<5> y0("");
    boost::btree::string_box<5> x0(y0);
    BOOST_TEST(x0 == ""); 
    
    boost::btree::string_box<5> y3("abc");
    boost::btree::string_box<5> x3(y3);
    BOOST_TEST(x3 == "abc"); 
    
    boost::btree::string_box<5> y5("abcdef");
    boost::btree::string_box<5> x5(y5);
    BOOST_TEST(x5 == "abcde"); 
  }
  ...
  {
    boost::btree::string_box<5> x0("xxx");
    x0 = "";
    BOOST_TEST(x0 == ""); 
    
    boost::btree::string_box<5> x3("xxxxx");
    x3 = "abc";
    BOOST_TEST(x3 == "abc"); 
    
    boost::btree::string_box<5> x5("xxx");
    x5 = "abcdef";
    BOOST_TEST(x5 == "abcde"); 
  }
  ...
  void relationals()
  {
    boost::btree::string_box<5> nul("");
    boost::btree::string_box<5> a("a");
    boost::btree::string_box<5> aa("aa");
    boost::btree::string_box<5> b("b");
